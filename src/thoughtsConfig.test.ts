...
describe("Profile Resolution", () => {
  ...
  describe("resolveProfileForRepo()", () => {
    ...
    it("should fall back to default for object mapping with invalid profile", () => {
      const result = resolveProfileForRepo(
        mockConfig,
        "/path/to/invalid-profile",
      );
    ...
    it("should handle profile with different directory names", () => {
      ...
      mockConfig.repoMappings["/path/to/work-project"] = {
        repo: "work-proj",
        profile: "work",
      };
      const workResult = resolveProfileForRepo(
        mockConfig,
  ...
  describe("getRepoNameFromMapping()", () => {
    ...
    it("should extract repo name from object mapping", () => {
      const mapping: RepoMappingObject = {
        repo: "test-repo",
        profile: "personal",
      };
